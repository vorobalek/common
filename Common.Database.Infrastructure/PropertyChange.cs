...
namespace Common.Database.Infrastructure
{
    public class PropertyChange
    {
        ...
        public PropertyChange(PropertyChange propertyChange) : this(propertyChange.PropertyEntry, propertyChange.EntityChange)
        {
        }
        ...
        public virtual bool IsModified => EntityChange.State is EntityState.Modified or EntityState.Unchanged && !Equals(Value, OriginalValue);
