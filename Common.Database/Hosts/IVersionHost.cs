...
namespace Common.Database.Hosts
{
    ...
    public sealed class VersionHostChangeListener<THost, TKey, TModel> : EntityHostChangeListener<THost, IVersionHost<THost, TKey, TModel>>
        where THost : Entity<THost>, IVersionHost<THost, TKey, TModel>, IIdTrait<TKey>, new()
        where TKey : IEquatable<TKey>
        where TModel : Entity<TModel>, IVersionModelHost<THost, TKey, TModel>, new()
    {
        ...
        public override void OnModelCreating(ModelBuilder builder)
        {
            ...
            foreach (var listener in _changeListenerServiceCache.GetListeners<TModel>())
            {
                listener.OnModelCreating(builder);
            }
        }
