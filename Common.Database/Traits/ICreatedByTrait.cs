...
namespace Common.Database.Traits
{
    ...
    public abstract class CreatedByChangeListener<TEntity, TKey> : EntityTraitChangeListener<TEntity, ICreatedByTrait<TKey>>
...
namespace Common.Database.Extensions
{
    public static partial class EntityExtensions
    {
        ...
        {
            return enumerable.Where(x => x.CreatedBy.Equals(key));
        }
