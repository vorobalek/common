...
namespace Common.Infrastructure
{
    public static class ExecutionEnvironment
    {
        ...
        public static bool IsEntityFrameworkTools => _isEntityFrameworkTools ??= Environment.StackTrace.Contains("Microsoft.EntityFrameworkCore.Design");
        public static bool IsInMemoryDatabase =>  _isInMemoryDatabase.GetValueOrDefault();
        public static void SetTesting(bool testing) => _isTesting = testing;
        public static void SetInMemoryDatabase(bool isInMemoryDatabase) => _isInMemoryDatabase = isInMemoryDatabase;
    }
}