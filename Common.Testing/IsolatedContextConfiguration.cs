...
public delegate Task PrepareIsolatedActionAsyncDelegate(IsolatedContext context,
    CancellationToken cancellationToken = default);

public delegate Task FinalizeIsolatedActionAsyncDelegate(IsolatedContext context,
    CancellationToken cancellationToken = default);

public delegate Task HandleIsolatedActionExceptionAsyncDelegate(IsolatedContext context, Exception exception,
    CancellationToken cancellationToken = default);
